...
export class DatabaseUser extends pulumi.CustomResource {
     ...
     */
    public readonly roles!: pulumi.Output<{ collectionName: string, databaseName: string, roleName: string }[]>;
    /**
...
export interface DatabaseUserState {
     ...
     * List of user’s roles and the databases / collections on which the roles apply. A role allows the user to perform particular actions on the specified database. A role on the admin database can include privileges that apply to the other databases as well. See Roles below for more details.
     */
    readonly roles?: pulumi.Input<pulumi.Input<{ collectionName?: pulumi.Input<string>, databaseName?: pulumi.Input<string>, roleName?: pulumi.Input<string> }>[]>;
    /**
     * Username for authenticating to MongoDB.
     */
