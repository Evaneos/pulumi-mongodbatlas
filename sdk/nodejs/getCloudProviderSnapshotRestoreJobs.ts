...
export interface GetCloudProviderSnapshotRestoreJobsResult {
     ...
     */
    readonly results: { cancelled: boolean, createdAt: string, deliveryType: string, deliveryUrls: string[], expired: boolean, expiresAt: string, finishedAt: string, id: string, snapshotId: string, targetClusterName: string, targetProjectId: string, timestamp: string }[];
