...
export class Cluster extends pulumi.CustomResource {
    ...
    public readonly advancedConfiguration!: pulumi.Output<{ failIndexKeyTooLong: boolean, javascriptEnabled: boolean, minimumEnabledTlsProtocol: string, noTableScan: boolean, oplogSizeMb: number, sampleRefreshIntervalBiConnector: number, sampleSizeBiConnector: number }>;
    /**
     ...
     */
    public readonly biConnector!: pulumi.Output<{ enabled: string, readPreference: string }>;
    /**
     * The cluster ID.
     */
    ...
    public readonly labels!: pulumi.Output<{ key: string, value: string }[]>;
    /**
    ...
    public /*out*/ readonly plugin!: pulumi.Output<{ name: string, version: string }>;
    /**
     ...
     */
    public readonly replicationSpecs!: pulumi.Output<{ id: string, numShards: number, regionsConfigs: { analyticsNodes?: number, electableNodes: number, priority: number, readOnlyNodes?: number, regionName: string }[], zoneName?: string }[]>;
    /**
...
export interface ClusterState {
    readonly advancedConfiguration?: pulumi.Input<{ failIndexKeyTooLong?: pulumi.Input<boolean>, javascriptEnabled?: pulumi.Input<boolean>, minimumEnabledTlsProtocol?: pulumi.Input<string>, noTableScan?: pulumi.Input<boolean>, oplogSizeMb?: pulumi.Input<number>, sampleRefreshIntervalBiConnector?: pulumi.Input<number>, sampleSizeBiConnector?: pulumi.Input<number> }>;
    /**
     * Specifies whether disk auto-scaling is enabled. The default is true.
     * - Set to `true` to enable disk auto-scaling.
     * - Set to `false` to disable disk auto-scaling.
     ...
     * Specifies BI Connector for Atlas configuration on this cluster. BI Connector for Atlas is only available for M10+ clusters. See BI Connector below for more details.
     */
    readonly biConnector?: pulumi.Input<{ enabled?: pulumi.Input<string>, readPreference?: pulumi.Input<string> }>;
    /**
     * The cluster ID.
     */
    ...
    readonly plugin?: pulumi.Input<{ name?: pulumi.Input<string>, version?: pulumi.Input<string> }>;
    /**
     * The unique ID for the project to create the database user.
     */
     ...
     * Configuration for cluster regions.  See Replication Spec below for more details.
     */
    readonly replicationSpecs?: pulumi.Input<pulumi.Input<{ id?: pulumi.Input<string>, numShards: pulumi.Input<number>, regionsConfigs?: pulumi.Input<pulumi.Input<{ analyticsNodes?: pulumi.Input<number>, electableNodes?: pulumi.Input<number>, priority?: pulumi.Input<number>, readOnlyNodes?: pulumi.Input<number>, regionName?: pulumi.Input<string> }>[]>, zoneName?: pulumi.Input<string> }>[]>;
    /**
     * Connection string for connecting to the Atlas cluster. The +srv modifier forces the connection to use TLS/SSL. See the mongoURI for additional options.
     */
