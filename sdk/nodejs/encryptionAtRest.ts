...
export class EncryptionAtRest extends pulumi.CustomResource {
     ...
     */
    public readonly awsKms!: pulumi.Output<{ accessKeyId: string, customerMasterKeyId: string, enabled: boolean, region: string, secretAccessKey: string } | undefined>;
    /**
     * Specifies Azure Key Vault configuration details and whether Encryption at Rest is enabled for an Atlas project.
     */
    public readonly azureKeyVault!: pulumi.Output<{ azureEnvironment: string, clientId: string, enabled: boolean, keyIdentifier: string, keyVaultName: string, resourceGroupName: string, secret: string, subscriptionId: string, tenantId: string } | undefined>;
    /**
     * Specifies GCP KMS configuration details and whether Encryption at Rest is enabled for an Atlas project.
     */
    public readonly googleCloudKms!: pulumi.Output<{ enabled: boolean, keyVersionResourceId: string, serviceAccountKey: string } | undefined>;
    /**
...
export interface EncryptionAtRestState {
     ...
     * Specifies AWS KMS configuration details and whether Encryption at Rest is enabled for an Atlas project.
     */
    readonly awsKms?: pulumi.Input<{ accessKeyId: pulumi.Input<string>, customerMasterKeyId: pulumi.Input<string>, enabled: pulumi.Input<boolean>, region: pulumi.Input<string>, secretAccessKey: pulumi.Input<string> }>;
    /**
     * Specifies Azure Key Vault configuration details and whether Encryption at Rest is enabled for an Atlas project.
     */
    readonly azureKeyVault?: pulumi.Input<{ azureEnvironment: pulumi.Input<string>, clientId: pulumi.Input<string>, enabled: pulumi.Input<boolean>, keyIdentifier: pulumi.Input<string>, keyVaultName: pulumi.Input<string>, resourceGroupName: pulumi.Input<string>, secret: pulumi.Input<string>, subscriptionId: pulumi.Input<string>, tenantId: pulumi.Input<string> }>;
    /**
     * Specifies GCP KMS configuration details and whether Encryption at Rest is enabled for an Atlas project.
     */
    readonly googleCloudKms?: pulumi.Input<{ enabled: pulumi.Input<boolean>, keyVersionResourceId: pulumi.Input<string>, serviceAccountKey: pulumi.Input<string> }>;
    /**
     * The unique identifier for the project.
     */
