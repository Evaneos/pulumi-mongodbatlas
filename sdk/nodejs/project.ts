...
export class Project extends pulumi.CustomResource {
    ...
    public readonly teams!: pulumi.Output<{ roleNames: string[], teamId: string }[] | undefined>;
...
export interface ProjectState {
    ...
    readonly teams?: pulumi.Input<pulumi.Input<{ roleNames: pulumi.Input<pulumi.Input<string>[]>, teamId: pulumi.Input<string> }>[]>;
}
