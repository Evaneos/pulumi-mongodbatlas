...
export class AlertConfiguration extends pulumi.CustomResource {
    ...
    public readonly matchers!: pulumi.Output<{ fieldName?: string, operator?: string, value?: string }[] | undefined>;
    public readonly metricThreshold!: pulumi.Output<{ metricName?: string, mode?: string, operator?: string, threshold?: number, units?: string } | undefined>;
    public readonly notifications!: pulumi.Output<{ apiToken?: string, channelName?: string, datadogApiKey?: string, datadogRegion?: string, delayMin?: number, emailAddress?: string, emailEnabled?: boolean, flowName?: string, flowdockApiToken?: string, intervalMin?: number, mobileNumber?: string, opsGenieApiKey?: string, opsGenieRegion?: string, orgName?: string, serviceKey?: string, smsEnabled?: boolean, teamId?: string, typeName?: string, username?: string, victorOpsApiKey?: string, victorOpsRoutingKey?: string }[]>;
    /**
...
export interface AlertConfigurationState {
    ...
    readonly matchers?: pulumi.Input<pulumi.Input<{ fieldName?: pulumi.Input<string>, operator?: pulumi.Input<string>, value?: pulumi.Input<string> }>[]>;
    readonly metricThreshold?: pulumi.Input<{ metricName?: pulumi.Input<string>, mode?: pulumi.Input<string>, operator?: pulumi.Input<string>, threshold?: pulumi.Input<number>, units?: pulumi.Input<string> }>;
    readonly notifications?: pulumi.Input<pulumi.Input<{ apiToken?: pulumi.Input<string>, channelName?: pulumi.Input<string>, datadogApiKey?: pulumi.Input<string>, datadogRegion?: pulumi.Input<string>, delayMin?: pulumi.Input<number>, emailAddress?: pulumi.Input<string>, emailEnabled?: pulumi.Input<boolean>, flowName?: pulumi.Input<string>, flowdockApiToken?: pulumi.Input<string>, intervalMin?: pulumi.Input<number>, mobileNumber?: pulumi.Input<string>, opsGenieApiKey?: pulumi.Input<string>, opsGenieRegion?: pulumi.Input<string>, orgName?: pulumi.Input<string>, serviceKey?: pulumi.Input<string>, smsEnabled?: pulumi.Input<boolean>, teamId?: pulumi.Input<string>, typeName?: pulumi.Input<string>, username?: pulumi.Input<string>, victorOpsApiKey?: pulumi.Input<string>, victorOpsRoutingKey?: pulumi.Input<string> }>[]>;
    /**
     * The ID of the project where the alert configuration will create.
     */
