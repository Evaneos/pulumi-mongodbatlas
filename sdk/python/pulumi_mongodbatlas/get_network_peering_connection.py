...
async def get_network_peering_connection(peering_id=None,project_id=None,opts=None):
    """
    ...
    __ret__ = await pulumi.runtime.invoke('mongodbatlas:index/getNetworkPeeringConnection:getNetworkPeeringConnection', __args__, opts=opts)
