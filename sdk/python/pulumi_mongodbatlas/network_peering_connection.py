...
class NetworkPeeringConnection(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, accepter_region_name=None, atlas_cidr_block=None, atlas_gcp_project_id=None, atlas_vpc_name=None, aws_account_id=None, azure_directory_id=None, azure_subscription_id=None, container_id=None, gcp_project_id=None, network_name=None, project_id=None, provider_name=None, resource_group_name=None, route_table_cidr_block=None, vnet_name=None, vpc_id=None, __name__=None, __opts__=None):
        ...
        super(NetworkPeeringConnection, __self__).__init__(
            'mongodbatlas:index/networkPeeringConnection:NetworkPeeringConnection',
            resource_name,
            __props__,
            opts)
