...
class GetAuditingResult:
    ...
    """
    def __init__(__self__, audit_authorization_success=None, audit_filter=None, configuration_type=None, enabled=None, project_id=None, id=None):
...
async def get_auditing(project_id=None,opts=None):
    """
    ...
    __ret__ = await pulumi.runtime.invoke('mongodbatlas:index/getAuditing:getAuditing', __args__, opts=opts)
