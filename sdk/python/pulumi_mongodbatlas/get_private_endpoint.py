...
class GetPrivateEndpointResult:
    ...
    """
    def __init__(__self__, endpoint_service_name=None, error_message=None, interface_endpoints=None, private_link_id=None, project_id=None, status=None, id=None):
...
async def get_private_endpoint(private_link_id=None,project_id=None,opts=None):
    """
    ...
    __ret__ = await pulumi.runtime.invoke('mongodbatlas:index/getPrivateEndpoint:getPrivateEndpoint', __args__, opts=opts)
