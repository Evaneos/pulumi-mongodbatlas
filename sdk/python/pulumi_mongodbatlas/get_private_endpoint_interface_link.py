...
class GetPrivateEndpointInterfaceLinkResult:
    ...
    """
    def __init__(__self__, connection_status=None, delete_requested=None, error_message=None, interface_endpoint_id=None, private_link_id=None, project_id=None, id=None):
...
async def get_private_endpoint_interface_link(interface_endpoint_id=None,private_link_id=None,project_id=None,opts=None):
    """
    ...
    __ret__ = await pulumi.runtime.invoke('mongodbatlas:index/getPrivateEndpointInterfaceLink:getPrivateEndpointInterfaceLink', __args__, opts=opts)
